...
var recipes = [
  {name:'sp_tacpts_HIT1', descr:'Тактика боя [1]', comp:['mater7',3], location:3, possible:0, accepted:0},
  {name:'sp_tacpts_HIT2', descr:'Тактика боя [2]', comp:['mater18',2], location:3, possible:0, accepted:0},
  {name:'sp_tacpts_HIT3', descr:'Тактика боя [3]', comp:['mater30',2], location:3, possible:0, accepted:0},
  {name:'sp_tacpts_HIT4', descr:'Тактика боя [4]', comp:['mater22',1], location:3, possible:0, accepted:0},
  {name:'sp_tacpts_HIT5', descr:'Тактика боя [5]', comp:['mater22',1,'mater23',1], location:3, possible:0, accepted:0},

  {name:'sp_tacpts_KRT1', descr:'Тактика крови [1]', comp:['mater9',3], location:3, possible:0, accepted:0},
  {name:'sp_tacpts_KRT2', descr:'Тактика крови [2]', comp:['mater16',2], location:3, possible:0, accepted:0},
  {name:'sp_tacpts_KRT3', descr:'Тактика крови [3]', comp:['mater27',2], location:3, possible:0, accepted:0},
  {name:'sp_tacpts_KRT4', descr:'Тактика крови [4]', comp:['mater31',1], location:3, possible:0, accepted:0},
  {name:'sp_tacpts_KRT5', descr:'Тактика крови [5]', comp:['mater31',1,'mater23',1], location:3, possible:0, accepted:0},

  {name:'sp_tacpts_CNTR1', descr:'Тактика ответа [1]', comp:['mater10',3], location:3, possible:0, accepted:0},
  {name:'sp_tacpts_CNTR2', descr:'Тактика ответа [2]', comp:['mater17',2], location:3, possible:0, accepted:0},
  {name:'sp_tacpts_CNTR3', descr:'Тактика ответа [3]', comp:['mater28',2], location:3, possible:0, accepted:0},
  {name:'sp_tacpts_CNTR4', descr:'Тактика ответа [4]', comp:['mater20',1], location:3, possible:0, accepted:0},
  {name:'sp_tacpts_CNTR5', descr:'Тактика ответа [5]', comp:['mater20',1,'mater23',1], location:3, possible:0, accepted:0},

  {name:'sp_tacpts_BLK1', descr:'Тактика защиты [1]', comp:['mater11',3], location:3, possible:0, accepted:0},
  {name:'sp_tacpts_BLK2', descr:'Тактика защиты [2]', comp:['mater19',2], location:3, possible:0, accepted:0},
  {name:'sp_tacpts_BLK3', descr:'Тактика защиты [3]', comp:['mater29',2], location:3, possible:0, accepted:0},
  {name:'sp_tacpts_BLK4', descr:'Тактика защиты [4]', comp:['mater21',1], location:3, possible:0, accepted:0},
  {name:'sp_tacpts_BLK5', descr:'Тактика защиты [5]', comp:['mater21',1,'mater23',1], location:3, possible:0, accepted:0},

  {name:'sp_tacpts_PRY1', descr:'Тактика отражения [1]', comp:['mater8',3], location:3, possible:0, accepted:0},
  {name:'sp_tacpts_PRY2', descr:'Тактика отражения [2]', comp:['mater15',2], location:3, possible:0, accepted:0},
  {name:'sp_tacpts_PRY3', descr:'Тактика отражения [3]', comp:['mater26',2], location:3, possible:0, accepted:0},
  {name:'sp_tacpts_PRY4', descr:'Тактика отражения [4]', comp:['mater24',1], location:3, possible:0, accepted:0},
  {name:'sp_tacpts_PRY5', descr:'Тактика отражения [5]', comp:['mater24',1,'mater23',1], location:3, possible:0, accepted:0},
